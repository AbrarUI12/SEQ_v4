...
| greedy_gptq | 4.82 | 44.80 | 71.46 | 73.25 | 69.05 | 77.26 | 69.85 | 67.61 | CATASTROPHIC control: residual-driven greedy on GPTQ (confirms F3 antagonism downstream) |
...
- **greedy_gptq − gptq4** (residual-driven protection is catastrophic on GPTQ (F3)): macro Δ = +0.51 [+0.13, +0.86] pts — paired bootstrap.
